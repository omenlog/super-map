...
type AsyncReducer<K, V, I, R = I extends undefined ? V : I> = (acc: R, value: V, key: K, m: ISuperMap<K, V>) => Promise<R>
...
interface ISuperMap<K, V> extends Map<K, V> {
    ...
    reduceAsync<I = undefined>(asyncReducer: AsyncReducer<K, V, I>, initialValue ? : I): I extends undefined ? Promise<V> : Promise<I>
}
